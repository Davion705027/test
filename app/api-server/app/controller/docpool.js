...
class DocpoolController extends Controller {
  async searchDoc() {
    try{
    const { keyword } = this.ctx.query
    const search = { $regex: RegExp(keyword), $options: 'i' }
    const result = await this.ctx.model.Docpool.paginate(
  ...
  */
  async index(){
    ...
    try {
      ...
      let result = await ctx.model.Docpool.paginate(query, options);
  ...
  async show() {
    ...
    try {
      ...
      const result = await ctx.model.Docpool.findById(id).exec();
  ...
  async create() {
    ...
    try {
      ...
      const result = await ctx.model.Docpool.create(final_obj);
      ctx.api_success_data(result);
    } catch (error) {
      ctx.api_error_msg(error);
    }
  ...
  async update() {
    ...
    try {
      ...
      let id = final_obj.id;
      delete final_obj.id;
      const result = await ctx.model.Docpool.findByIdAndUpdate(id, final_obj);
      ctx.api_success_data(result);
    } catch (error) {
      ctx.api_error_msg(error);
    }
  ...
  async destroy() {
    ...
    try {
      ...
      const result = await ctx.model.Docpool.findByIdAndDelete(id);
      ctx.api_success_data(result);
    } catch (error) {
      ctx.api_error_msg(error);
    }
  ...
  async disable() {
    ...
    try {
      ...
      const result = await ctx.model.Docpool.findByIdAndUpdate(id, update);
      ctx.api_success_data(result);
    } catch (error) {
      ctx.api_error_msg(error);
    }
...
module.exports = DocpoolController;
