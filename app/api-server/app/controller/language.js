...
class LanguageController extends Controller {
  ...
  async index() {
    ...
    try {
      ...
      const result = await ctx.model.Language.paginate(query, options);
  ...
  async show() {
    ...
    try {
      ...
      const result = await ctx.model.Language.findById(id,{password:-1}).exec();
      ctx.api_success_data(result);
    } catch (error) {
      ctx.api_error_msg(error);
    }
  ...
  async create() {
    ...
    try {
      ...
      const result = await ctx.model.Language.create(final_obj);
      ctx.api_success_data(result);
    } catch (error) {
      ctx.api_error_msg(error);
    }
  ...
  async update() {
    ...
    try {
      ...
      let id = final_obj.id;
      delete final_obj.id;
      const result = await ctx.model.Language.findByIdAndUpdate(id, final_obj);
      ctx.api_success_data(result);
    } catch (error) {
      ctx.api_error_msg(error);
    }
  ...
  async destroy() {
    ...
    try {
      ...
      const result = await ctx.model.Language.findByIdAndDelete(id);
      ctx.api_success_data(result);
    } catch (error) {
      ctx.api_error_msg(error);
    }
