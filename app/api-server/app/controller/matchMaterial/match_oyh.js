...
class MatchOyhController extends Controller {
  /**
   * 查询  全部数据
   * @returns
   */
  async index() {
    ...
    try {
      ...
      const result = await ctx.model.MatchMaterial.MatchOyh.paginate(query, {
  ...
  async findAll() {
    const ctx = this.ctx;
    try {
      const result = await ctx.model.MatchMaterial.MatchOyh.find({ status: 1 });
      ctx.api_success_data(result);
    } catch (error) {
      ctx.api_error_msg(error);
    }
  ...
  async findOneByCid() {
    const ctx = this.ctx;
    try {
      const result = await ctx.model.MatchMaterial.MatchOyh.findById(ctx.query.cid);
      ctx.api_success_data(result);
    } catch (error) {
      ctx.api_error_msg(error);
    }
  ...
  async create() {
    ...
    try {
      ...
      const result = await ctx.model.MatchMaterial.MatchOyh.create(data);
      ctx.api_success_data(result);
    } catch (error) {
      ctx.api_error_msg(error);
    }
  ...
  async update() {
    ...
    try {
      ...
      ctx.remove_false_key(data);
      await ctx.model.MatchMaterial.MatchOyh.findByIdAndUpdate(id, data);
  ...
  async destroy() {
    ...
    try {
      ...
      const result = await ctx.model.MatchMaterial.MatchOyh.findByIdAndDelete(id);
      ctx.api_success_data(result);
    } catch (error) {
      ctx.api_error_msg(error);
    }
...
module.exports = MatchOyhController;
