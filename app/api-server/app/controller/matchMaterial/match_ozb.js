...
class MatchOzbController extends Controller {
  /**
   * 查询  全部数据
   * @returns
   */
  async index() {
    ...
    try {
      ...
      const result = await ctx.model.MatchMaterial.MatchOzb.paginate(query, {
  ...
  async findAll() {
    const ctx = this.ctx;
    try {
      const result = await ctx.model.MatchMaterial.MatchOzb.find({ status: 1 });
      ctx.api_success_data(result);
    } catch (error) {
      ctx.api_error_msg(error);
    }
  ...
  async findOneByCid() {
    const ctx = this.ctx;
    try {
      const result = await ctx.model.MatchMaterial.MatchOzb.findById(ctx.query.cid);
      ctx.api_success_data(result);
    } catch (error) {
      ctx.api_error_msg(error);
    }
  ...
  async create() {
    ...
    try {
      ...
      const result = await ctx.model.MatchMaterial.MatchOzb.create(data);
      ctx.api_success_data(result);
    } catch (error) {
      ctx.api_error_msg(error);
    }
  ...
  async update() {
    ...
    try {
      ...
      ctx.remove_false_key(data);
      await ctx.model.MatchMaterial.MatchOzb.findByIdAndUpdate(id, data);
  ...
  async destroy() {
    ...
    try {
      ...
      const result = await ctx.model.MatchMaterial.MatchOzb.findByIdAndDelete(id);
      ctx.api_success_data(result);
    } catch (error) {
      ctx.api_error_msg(error);
    }
...
module.exports = MatchOzbController;
