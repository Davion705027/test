...
class MdHistoryController extends Controller {
  /**
   * 查询  全部数据
   * @returns
   */
  async index() {
    ...
    try {
      ...
      const result = await ctx.model.MdHistory.paginate(query, options);
  ...
  async show() {
    ...
    try {
      ...
      const result = await ctx.model.MdHistory.findById(id).exec();
      ctx.api_success_data(result);
    } catch (error) {
      ctx.api_error_msg(error);
    }
  ...
  async create() {
    ...
    try {
      ...
      const result = await ctx.model.MdHistory.create(final_obj);
      ctx.api_success_data(result);
    } catch (error) {
      ctx.api_error_msg(error);
    }
  ...
  async update() {
    ...
    try {
      ...
      let id = final_obj.id;
      delete final_obj.id;
      const result = await ctx.model.MdHistory.findByIdAndUpdate(
        id,
        final_obj
      );
      ctx.api_success_data(result);
  ...
  async destroy() {
    ...
    try {
      ...
      const result = await ctx.model.MdHistory.findByIdAndDelete(id);
      ctx.api_success_data(result);
    } catch (error) {
  ...
  async disable() {
    ...
    try {
      ...
      const result = await ctx.model.MdHistory.findByIdAndUpdate(id, update);
      ctx.api_success_data(result);
    } catch (error) {
      ctx.api_error_msg(error);
    }
   ...
   */
   async related_record() {
    ...
    try {
      ...
      const result = await ctx.model.MdHistory.find( query,'',options ).exec();
      ctx.api_success_data(result);
    } catch (error) {
      ctx.api_error_msg(error);
    }
...
module.exports = MdHistoryController;
