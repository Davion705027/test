/*
 * @FilePath: /client-api-doc-server/app/service/scanAssets.js
    扫描大赛
...
class ScanMatchService extends Service {
  ...
  async create2(file){
    ...
    // // 服务器是否已存在
    // const find_one = await this.ctx.model.ScanMatch.findOne({path:request_obj.path})
    // if(find_one){
    //   await this.ctx.model.ScanMatch.updateOne({path:request_obj.path},{...final_obj})
    // }else{
    //   await this.ctx.model.ScanMatch.create(final_obj)
    // }
...
module.exports = ScanMatchService;
