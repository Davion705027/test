...
class AnalyzeMatchHistoryBasketBallTesChildItem extends StatelessWidget {
  AnalyzeVSInfoEntity analyzeVSInfoEntity;
  int index;
  AnalyzeMatchHistoryBasketBallTesChildItem(this.index,this.analyzeVSInfoEntity, {super.key});
