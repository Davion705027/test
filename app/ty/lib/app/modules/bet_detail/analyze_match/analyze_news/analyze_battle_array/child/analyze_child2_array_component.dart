...
class AnalyzeChild2ArrayComponent extends StatelessWidget {
  @override
                  ...
                  child: Container(
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        ItemHeaderWidget(
                          name:
                              '${LocaleKeys.analysis_football_matches_starting_lineup.tr}${controller.state.analyzeArrayPersonEntity2.value.homeFormation ?? ""}',
                        ),
                        AnalyzeDivider(),
                        buildBody(),
                      ],
    ...
    return GetBuilder<AnalyzeBattleArrayLogic>(
        ...
        builder: (controller) {
          return Column(
            children: [
              AnalyzeDivider(),
              (controller.state.analyzeArrayPersonEntity2.value.down == null ||
                      controller.state.analyzeArrayPersonEntity2.value.down
                              ?.isEmpty ==
                          true)
                  ? TextNoData()
                  : Container(
                      ...
                      child: ListView.separated(
                        ...
                        scrollDirection: Axis.vertical,
                        itemCount: controller.state.analyzeArrayPersonEntity2
                                .value.down?.length ??
                            0,
                        shrinkWrap: true,
                        ...
                        itemBuilder: (BuildContext context, int index) {
                          return AnalyzeChildItem(controller
                                  .state
                                  .analyzeArrayPersonEntity2
                                  .value
                                  .down?[index] ??
                              Up());
                        },
  ...
  buildList() {
    return GetBuilder<AnalyzeBattleArrayLogic>(
        id: "buildList2",
        builder: (controller) {
          return (controller.state.analyzeArrayPersonEntity2.value.up == null ||
                  controller
              ...
              : Container(
                  ...
                  child: ListView.separated(
                    ...
                    itemCount: controller
                            .state.analyzeArrayPersonEntity2.value.up?.length ??
                        0,
                    shrinkWrap: true,
                    physics: NeverScrollableScrollPhysics(),
                    ...
                    //列表项构造器
                    itemBuilder: (BuildContext context, int index) {
                      return AnalyzeChildItem(controller.state
                              .analyzeArrayPersonEntity2.value.up?[index] ??
                          Up());
                    },
                    //分割器构造器
                    separatorBuilder: (BuildContext context, int index) {
