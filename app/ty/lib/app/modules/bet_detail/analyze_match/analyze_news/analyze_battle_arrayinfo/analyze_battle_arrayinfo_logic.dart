...
import 'analyze_battle_arrayinfo_state.dart';

class AnalyzeBattleArrayInfoLogic extends GetxController
    with GetSingleTickerProviderStateMixin {
  final AnalyzeBattleArrayInfoState state = AnalyzeBattleArrayInfoState();
    ...
    tabController = TabController(length: 2, vsync: this)
      ..addListener(() {
        if (tabController.index.toDouble() == tabController.animation?.value) {
          ...
          update(["analyzeList", "analyzeChildArrayInfoComponent"]);
          update(["analyzeList2", "analyzeChildArrayInfoComponent2"]);
        }
      });
    map = {
  ...
  void requestData() async {
    ...
    update(["analyzeChildArrayInfoComponent2"]);
    requestGetArticle();
  }
  ...
  void requestGetArticle() {
    ...
    AnalyzeDetailApi.instance().getMatchLineupList(mid, "2").then((value) {
      state.analyzeArrayInfoPersonEntity2.value = value.data??AnalyzeArrayPersonEntity();
      update(["analyzeList2", "analyzeChildArrayInfoComponent"]);
    ...
    //   AnalyzeArrayInfoPersonEntity analyzeArrayInfoPersonEntity =
    //       AnalyzeArrayInfoPersonEntity.fromJson(jsonDecode(data));
    //   state.analyzeArrayInfoPersonEntity.value = analyzeArrayInfoPersonEntity;
    //   update(["buildList", "analyzeChildArrayInfoComponent"]);
    // });
    //
    // Future.delayed(Duration(seconds: 3), () {
    //   String data =
    ...
    //   AnalyzeArrayInfoPersonEntity analyzeArrayInfoPersonEntity =
    //       AnalyzeArrayInfoPersonEntity.fromJson(jsonDecode(data));
    //   state.analyzeArrayInfoPersonEntity2.value = analyzeArrayInfoPersonEntity;
    //   update(["buildList2", "analyzeChildArrayInfoComponent2"]);
    // });
  }
