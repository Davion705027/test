...
class AnalyzeBattleArrayInfoHead extends StatelessWidget {
  AnalyzeBattleArrayInfoHead({super.key});
  @override
  Widget build(BuildContext context) {
    return GetBuilder<AnalyzeBattleArrayInfoLogic>(
          ...
          builder: (controller){
            ...
            var dataList=((controller.state.curMainTab.value==1?controller.state.analyzeArrayPersonEntity.value.up:controller.state.analyzeArrayInfoPersonEntity2.value.up)??[]);
            return Container(
