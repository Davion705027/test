 ...
 * @function[功能简介 ]
 **/
class AnalyzeInformationTab extends StatefulWidget {
  const AnalyzeInformationTab({Key? key}) : super(key: key);

  @override
  State<AnalyzeInformationTab> createState() => _MSTabbarDemo1State();
}

class _MSTabbarDemo1State extends State<AnalyzeInformationTab> {
  List<String> _tabs = ["", ""];
  ...
  Widget build(BuildContext context) {
    return GetBuilder<AnalyzeBattleArrayLogic>(
        id: "tabListChange",
        builder: (controller1) {
          _tabs = controller1.state.teamsNames.value;
