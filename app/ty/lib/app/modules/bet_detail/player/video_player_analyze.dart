...
import 'analyze_progress_bar.dart';
...
class VideoPlayerAnalyze extends StatefulWidget {
  const VideoPlayerAnalyze(
      {Key? key,
  ...
  const VideoPlayerAnalyze.network(this.videoPath,
      {Key? key,
  ...
  const VideoPlayerAnalyze.file(this.videoPath,
      {Key? key,
  ...
  const VideoPlayerAnalyze.asset(this.videoPath,
      {Key? key,
  ...
  @override
  _VideoPlayerAnalyzeState createState() => _VideoPlayerAnalyzeState();
}

class _VideoPlayerAnalyzeState extends State<VideoPlayerAnalyze> {
