...
import 'notice_center_logic.dart';

class NoticeCenterController extends GetxController
    with GetSingleTickerProviderStateMixin {
  static NoticeCenterController get to => Get.put(NoticeCenterController());
  final NoticeCenterlogic logic = NoticeCenterlogic();
