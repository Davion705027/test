...
class NoticeCenterTabPage extends StatefulWidget {
  const NoticeCenterTabPage({Key? key}) : super(key: key);

  @override
  State<NoticeCenterTabPage> createState() => _NoticeCenterPageState();
}

class _NoticeCenterPageState extends State<NoticeCenterTabPage> {
