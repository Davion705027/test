...
import 'notice_ttbody_logic.dart';



class NoticeTtBodyController extends GetxController
    with GetSingleTickerProviderStateMixin {
  static NoticeTtBodyController get to => Get.put(NoticeTtBodyController());
  final NoticeTtBodylogic logic = NoticeTtBodylogic();
