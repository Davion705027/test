...
class NoticeTtBodyPage extends StatefulWidget {
  const NoticeTtBodyPage({Key? key}) : super(key: key);

  @override
  State<NoticeTtBodyPage> createState() => _NoticeTtBodyPageState();
}

class _NoticeTtBodyPageState extends State<NoticeTtBodyPage> {
  final controller = Get.find<NoticeTtBodyController>();
  final logic = Get.find<NoticeTtBodyController>().logic;

  @override
  Widget build(BuildContext context) {
    return GetBuilder<NoticeTtBodyController>(
      builder: (controller) {
  ...
  @override
  void dispose() {
    Get.delete<NoticeTtBodyController>();
    super.dispose();
  }
}
