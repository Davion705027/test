...
class BasketVlcVideoPlayerView extends StatefulWidget {
  final VlcPlayerController controller;
  final double aspectRatio;
  final Widget? placeholder;
  final bool virtualDisplay;

  const BasketVlcVideoPlayerView({
  ...
  @override
  BasketVlcVideoPlayerViewState createState() =>
      BasketVlcVideoPlayerViewState();
}

class BasketVlcVideoPlayerViewState extends State<BasketVlcVideoPlayerView> {
  ...
  @override
  void didUpdateWidget(BasketVlcVideoPlayerView oldWidget) {
