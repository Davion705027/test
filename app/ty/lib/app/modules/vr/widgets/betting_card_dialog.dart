...
class BettingCartDialog extends StatefulWidget {
  const BettingCartDialog._({
    super.key,
    required this.type,
  ...
  factory BettingCartDialog.single({
    Key? key,
  }) =>
      BettingCartDialog._(
        key: key,
  ...
  factory BettingCartDialog.multi({
    Key? key,
  }) =>
      BettingCartDialog._(
        key: key,
  ...
  factory BettingCartDialog.orderStatus({
    Key? key,
  }) =>
      BettingCartDialog._(
        key: key,
  ...
  @override
  State<BettingCartDialog> createState() => _BettingCartDialogState();
}

class _BettingCartDialogState extends State<BettingCartDialog> {
                  ...
                  children: [
                    ...
                    ConstrainedBox(
                      constraints: BoxConstraints(
                          maxHeight: widget.type == 3 ? 350 : 450),
                      child: SingleChildScrollView(
                        child: Column(
                          mainAxisAlignment: MainAxisAlignment.end,
                          children: [
                ...
                children: [
                  ...
                  GestureDetector(
                    onTap: () {
                      ...
                      BettingCartController.of
                          .onBettingTypeChanged(_bettingType);
                      Get.back();
                    },
                    child: Container(
                      decoration: BoxDecoration(
