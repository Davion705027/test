...
class GoingSportDetailWidget extends StatefulWidget {
  const GoingSportDetailWidget({
    super.key,
    required this.type,
  ...
  @override
  State<GoingSportDetailWidget> createState() => _GoingSportDetailWidgetState();
}

class _GoingSportDetailWidgetState extends State<GoingSportDetailWidget> {
...
extension _BallsUI on _GoingSportDetailWidgetState {
...
extension _DogHorseUI on _GoingSportDetailWidgetState {
...
extension _TeamsScoreHelper on _GoingSportDetailWidgetState {
...
extension _GoingSportDetailWidgetStateLogic on _GoingSportDetailWidgetState {
  ...
  Future<void> _getReplay() async {
    debugPrint('_replayEntity: ${_replayEntity?.toJson()}');
