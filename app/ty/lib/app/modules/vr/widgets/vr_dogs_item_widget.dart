...
class VrDogsItemWidget extends StatefulWidget {
  const VrDogsItemWidget({
    super.key,
  });

  @override
  State<VrDogsItemWidget> createState() => _VrDogsItemWidgetState();
}

class _VrDogsItemWidgetState extends State<VrDogsItemWidget> {
  int _selTeamIndex = 0;
