...
class VrHorseWidget extends StatefulWidget {
  const VrHorseWidget({
    super.key,
  });

  @override
  State<VrHorseWidget> createState() => _VrHorseWidgetState();
}

class _VrHorseWidgetState extends State<VrHorseWidget> {
  int _selTeamIndex = 0;
